function osmTable(pContainer, showIDs, showType, showGeometry) {
  ...
  this.setValue = function setValue(data) {
      // Doesn't look like this contains relations...
  ...
  this.generateTable = function generateTable() {
    ...
    //    console.log("gen table: "+this.value.features.length);
    ...
    var thisvalue = this.value;
      for (var j=0; j<thisvalue.features.length; j++) {
	  //  console.log("gen table: "+ j);
        var feature = thisvalue.features[j];
        var fixedColumns = {};
        //the fixed columns:
