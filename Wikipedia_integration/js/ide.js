...
var ide = new(function() {
  ...
  this.mwapi = function(instr, callback) {
    var lang = ide.getQueryLang();
    console.log('1 '+instr);
    callback("");
    /*
  ...
  this.getQuery = function(callback) {
    ...
    var shortcuts = {
      ...
      "mwapi": ide.mwapi,       /* mediawiki api query */
    };
    queryParser.parse(query, shortcuts, function(query) {
      ...
      ide.mapcss = mapcss;
      // Parse mwapi
      var mwapi_instructions = "";
      if (queryParser.hasStatement("mwapi")) {
        mwapi_instructions = queryParser.getStatement("mwapi");
	console.log('2 '+mwapi_instructions);
	// Do something with mwapi
	mwapi.init(ide,mwapi_instructions);
      };
  ...
  this.onExportClick = function() {
   ...
   ide.getQuery(function(query) {
    ...
    $("#export-dialog a#export-text")[0].href = "data:text/plain;charset="+(document.characterSet||document.charset)+";base64,"+Base64.encode(queryWithMapCSS,true);
    var dialog_buttons= {};
    dialog_buttons[i18n.t("dialog.done")] = function() {$(this).dialog("close");};
