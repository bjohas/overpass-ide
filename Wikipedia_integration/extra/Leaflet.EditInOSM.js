...
Very minor modifications by http://bjohas.de (adding a link for JOSM/Zoom).
Used in https://github.com/bjohas/overpass-ide 
*/
(function (factory) {
    var L;
    ...
    var _controlContainer,
        ...
        _Editors = {
            ...
            JosmZ: function (config) {
                var url = 'http://127.0.0.1:8111/zoom',
                    timeout = 1000,
                    displayName = "JOSM: zoom",
                    buildUrl = function (map) {
                        var bounds = map.getBounds();
                        return this.url + L.Util.getParamString({
                            left: bounds.getNorthWest().lng,
    ...
    L.Control.EditInOSM = L.Control.extend({
        ...
        initialize: function (options) {
            ...
            for (var i in this.options.editors) {
                ...
                } else if (editorSmallName === "josmz") {
                    newEditors.push(new _Editors.JosmZ());
